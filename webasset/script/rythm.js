...
var borderColor = (function (elem, value) {
  ...
  var from = options.from || [0, 255, 255];
  var to = options.to || [0, 255, 255];
...
var imageShadow = (function (elem, value) {
  ...
  var min = !isNaN(options.min) ? options.min : 0.75;
  var scale = (max - min) * value;
  elem.style['filter'] = `brightness(10%) sepia(1) saturate(100) hue-rotate(275deg) drop-shadow(0 0 ${scale}px #91ffff)`
})

var reset$17 = function reset(elem) {
  elem.style['filter'] = 'brightness(10%) sepia(1) saturate(100) hue-rotate(275deg) drop-shadow(0 0 10px #91ffff)'
}
